    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-8">
            ...
            {isEditingName ? (
              <div className="flex items-center gap-3">
                <Input
                  ...
                  className="text-4xl font-black tracking-tight h-auto py-1 px-2 border-b-2 border-[var(--foreground)] border-t-0 border-l-0 border-r-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0"
                  autoFocus
                  onKeyDown={(e) => {
          ...
          {/* ── Stats strip ── */}
          <div className="border-t-2 border-b-2 border-[var(--border)] py-5 mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-12">
            <div>
